...
export const metadata: Metadata = {
  title: "PawCare Pro - Complete Pet Care Services & Premium Supplies",
  description: "Professional pet grooming, veterinary care, training, and premium supplies. Trusted by 5000+ pet families. Book your pet's appointment today!",
  keywords: "pet grooming, veterinary care, pet training, pet boarding, premium pet food, pet supplies, professional pet care",
  openGraph: {
    title: "PawCare Pro - Complete Pet Care Services & Premium Supplies",
    description: "Professional pet grooming, veterinary care, training, and premium supplies. Trusted by 5000+ pet families.",
    siteName: "PawCare Pro",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SzEkxKoNyIbQ4hnQYui6BHsfB/uploaded-1763290727482-5z45zh8x.jpg",
  ...
  twitter: {
    ...
    title: "PawCare Pro - Complete Pet Care Services",
    description: "Professional pet grooming, veterinary care, training, and premium supplies. Trusted by 5000+ pet families.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SzEkxKoNyIbQ4hnQYui6BHsfB/uploaded-1763290727482-5z45zh8x.jpg"]
  },
  robots: {
    index: true,
    follow: true
